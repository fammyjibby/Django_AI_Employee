...
class Conversation(models.Model):
    ...
    def __str__(self):
        return f"Conversation {self.id} - User: {self.user.username}/ order: {self.order.id}"
...
class Message(models.Model):
    ...
    def __str__(self):
      return f"{self.role}: {self.content[:50]}...Agent: we are working on your request and will get back to you shortly."
